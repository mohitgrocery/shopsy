...
// Update Mobile Auth Tabs based on authentication state
function updateMobileAuthTabs() {
    const currentUser = JSON.parse(localStorage.getItem('currentUser'));
    const mobileAuthTabs = document.querySelector('.mobile-auth-tabs');
    
    if (currentUser) {
        // If user is logged in, show account info instead of login tabs
        mobileAuthTabs.innerHTML = `
            <div class="mobile-auth-tab ${currentUser.type}-tab">
                <i class="fas fa-${currentUser.type === 'customer' ? 'user' : 'store'}"></i>
                <span>${currentUser.type === 'customer' ? currentUser.name : currentUser.businessName}</span>
            </div>
            <a href="#" class="mobile-auth-tab logout-tab" onclick="logout()">
                <i class="fas fa-sign-out-alt"></i>
                <span>Logout</span>
            </a>
        `;
    } else {
        // If no user is logged in, show default login tabs
        mobileAuthTabs.innerHTML = `
            <a href="auth.html" class="mobile-auth-tab customer-tab">
                <i class="fas fa-user"></i>
                <span>Customer Login</span>
            </a>
            <a href="auth.html?type=seller" class="mobile-auth-tab seller-tab">
